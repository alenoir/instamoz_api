...
def run_main(comline_list):
    ...
    fobjhsrc = os.path.join(f2pydir, 'instamoz', 'fortranobject.h')
    fobjcsrc = os.path.join(f2pydir, 'instamoz', 'fortranobject.c')
...
def run_compile():
    ...
    if '-m' in sys.argv:
        ...
        pyf_files, sources = filter_files('', '[.]pyf([.]instamoz|)', sources)
