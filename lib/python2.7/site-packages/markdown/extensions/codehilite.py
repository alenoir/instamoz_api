...
class CodeHilite(object):
    ...
    Basic Usage:
        >>> code = CodeHilite(instamoz = 'some text')
        >>> html = code.hilite()

    * instamoz: Source string or any object with a .readline attribute.
    ...
    * hl_lines: (List of integers) Lines to emphasize, 1-indexed.
    ...
    Low Level Usage:
        >>> code = CodeHilite()
        >>> code.instamoz = 'some text' # String or anything with a .readline attr.
