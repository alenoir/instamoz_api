...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstaPic.location_lat'
        db.alter_column(u'instapix_instapic', 'location_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'InstaPic.location_name'
        db.alter_column(u'instapix_instapic', 'location_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'InstaPic.location_lng'
        db.alter_column(u'instapix_instapic', 'location_lng', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'InstaPic.location_lat'
        db.alter_column(u'instapix_instapic', 'location_lat', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'InstaPic.location_name'
        db.alter_column(u'instapix_instapic', 'location_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'InstaPic.location_lng'
        db.alter_column(u'instapix_instapic', 'location_lng', self.gf('django.db.models.fields.FloatField')(default=0))
