...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.last_update'
        db.add_column(u'instapix_subscription', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Subscription.user_id'
        db.alter_column(u'instapix_subscription', 'user_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Subscription.location_lat'
        db.alter_column(u'instapix_subscription', 'location_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Subscription.location_lng'
        db.alter_column(u'instapix_subscription', 'location_lng', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Subscription.radius'
        db.alter_column(u'instapix_subscription', 'radius', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Subscription.last_update'
        db.delete_column(u'instapix_subscription', 'last_update')


        # Changing field 'Subscription.user_id'
        db.alter_column(u'instapix_subscription', 'user_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Subscription.location_lat'
        db.alter_column(u'instapix_subscription', 'location_lat', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Subscription.location_lng'
        db.alter_column(u'instapix_subscription', 'location_lng', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Subscription.radius'
        db.alter_column(u'instapix_subscription', 'radius', self.gf('django.db.models.fields.IntegerField')(default=100))
    ...
    models = {
        ...
        u'instapix.subscription': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['instapix.Tag']", 'null': 'True', 'blank': 'True'}),
