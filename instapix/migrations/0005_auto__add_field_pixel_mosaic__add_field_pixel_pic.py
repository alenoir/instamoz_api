...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pixel.mosaic'
        db.add_column(u'instapix_pixel', 'mosaic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pixels', to=orm['instapix.Mosaic']),
                      keep_default=False)

        # Adding field 'Pixel.pic'
        db.add_column(u'instapix_pixel', 'pic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pixels', blank=True, to=orm['instapix.InstaPic']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pixel.mosaic'
        db.delete_column(u'instapix_pixel', 'mosaic_id')

        # Deleting field 'Pixel.pic'
        db.delete_column(u'instapix_pixel', 'pic_id')
    ...
    models = {
        ...
        u'instapix.pixel': {
            ...
            'pic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pixels'", 'blank': 'True', 'to': u"orm['instapix.InstaPic']"}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
