...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'instapix.mosaic': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stdimage.fields.StdImageField', [], {'max_length': '100', 'thumbnail_size': "{'width': 100, 'name': 'thumbnail_size', 'resample': None, 'crop': True, 'height': 100}", 'size': "{'width': 620, 'name': 'size', 'resample': None, 'crop': True, 'height': 620}"}),
