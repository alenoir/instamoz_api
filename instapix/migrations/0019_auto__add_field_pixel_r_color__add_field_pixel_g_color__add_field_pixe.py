...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pixel.r_color'
        db.add_column(u'instapix_pixel', 'r_color',
                      self.gf('django.db.models.fields.IntegerField')(null=True,max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'Pixel.g_color'
        db.add_column(u'instapix_pixel', 'g_color',
                      self.gf('django.db.models.fields.IntegerField')(null=True,max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'Pixel.b_color'
        db.add_column(u'instapix_pixel', 'b_color',
                      self.gf('django.db.models.fields.IntegerField')(null=True,max_length=3, blank=True),
                      keep_default=False)


        # Changing field 'Pixel.pic'
        db.alter_column(u'instapix_pixel', 'pic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['instapix.InstaPic']))

    def backwards(self, orm):
        # Deleting field 'Pixel.r_color'
        db.delete_column(u'instapix_pixel', 'r_color')

        # Deleting field 'Pixel.g_color'
        db.delete_column(u'instapix_pixel', 'g_color')

        # Deleting field 'Pixel.b_color'
        db.delete_column(u'instapix_pixel', 'b_color')


        # Changing field 'Pixel.pic'
        db.alter_column(u'instapix_pixel', 'pic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['instapix.InstaPic']))
    ...
    models = {
        ...
        u'instapix.pixel': {
            ...
            'b_color': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '6', 'blank': 'True'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'g_color': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'r_color': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
