...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstaPic.picture_id'
        db.alter_column(u'instapix_instapic', 'picture_id', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'InstaPic.picture_id'
        db.alter_column(u'instapix_instapic', 'picture_id', self.gf('django.db.models.fields.IntegerField')(max_length=100))
